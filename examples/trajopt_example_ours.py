...
def demo_trajopt_collision_free():
    ...
    print(join_path(get_robot_configs_path(), robot_file))
    # /home/nataliya/curobo/src/curobo/content/configs/robot/franka.yml
    ...
    # /home/nataliya/curobo/src/curobo/content/configs/world/collision_table.yml
